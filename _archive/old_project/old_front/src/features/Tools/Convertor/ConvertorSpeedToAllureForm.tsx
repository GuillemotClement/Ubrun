...
export default function ConvertorSpeedToAllureForm({ setResult }: ConvertorSpeedToAllureFormProps) {
  const form = useForm({
    defaultValues,
    validators: {
      onChange: schema,
  ...
  return (
    ...
    >
      ...
      <form.Field name="speed">
        {(field) => (
          <FormField field={field} isRequired={true} label="Vitesse en km/h" type="number" />
        )}
      </form.Field>
