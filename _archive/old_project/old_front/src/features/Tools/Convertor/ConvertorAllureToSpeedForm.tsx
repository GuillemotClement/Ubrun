...
export default function ConvertorAllureToSpeedForm({ setResult }: ConvertorAllureToSpeedFormProps) {
  const form = useForm({
    defaultValues,
    validators: {
      onChange: schema,
    ...
    onSubmit: ({ value }) => {
      ...
      const result = convertorTool.convertAllureToSpeed(numericMinute, numericSeconde);
