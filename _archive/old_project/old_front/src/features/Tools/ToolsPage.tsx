        ...
        <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <ul className="menu w-full grow">
            ...
            <li>
              ...
              >
                <House />
                <span className="is-drawer-close:hidden">Accueil outils</span>
              </Link>
            </li>
            ...
            <li>
              ...
              >
                <Percent />
                <span className="is-drawer-close:hidden">Calcul de pourcentage</span>
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="is-drawer-close:hidden">Fréquence Cardiaque</span>
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="is-drawer-close:hidden">Vitesse Maximal Aérobique</span>
              </Link>
            </li>
