  ...
  return (
    <div className="container mx-auto flex flex-1 flex-col items-center">
      <div className="flex gap-x-3">
        ...
        <button className="btn" type="button" onClick={() => setDistance(21.097)}>
          Semi
        </button>
        <button className="btn" type="button" onClick={() => setDistance(42.195)}>
          Marathon
        </button>
      </div>
      ...
      >
        ...
        <form.Field name="distance">
          {(field) => <FormField field={field} isRequired={true} label="Distance" type="Number" />}
        </form.Field>

        <div className="flex gap-x-3">
          <form.Field name="min">
            {(field) => <FormField field={field} isRequired={true} label="Minute" type="Number" />}
          </form.Field>

          <form.Field name="second">
            {(field) => <FormField field={field} isRequired={true} label="Seconde" type="Number" />}
          </form.Field>
        </div>
